...
Next, we need to filter out plays that don't fall into our operational definition of success. For example, under the defintion above, how would we determine if a kickoff was successful? Therefore, I will use the `filter()` function to select only passing or rushing plays.
